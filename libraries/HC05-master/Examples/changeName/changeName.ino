 ...
 *
 * This works with a Blud:\Adam\Documents\Arduino\libraries\HC05-master\HC05.cpp d:\Adam\Documents\Arduino\libraries\HC05-master\HC05.hetooth terd:\Adam\Documents\Arduino\libraries\HC05-master\HardwarSerial.fzzminal. The user is prompted for a new
...
HC05 btSerial = HC05(A2, A5, 10, 11);  // cmd, state, rx, tx
#else

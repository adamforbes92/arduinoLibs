...
void loop() {
  // Create Data Package
  byte package[4] = {0xA2, 0x08, 0x03, 0x00}; // 31 - control byte, 255 - red, 0 - green, 0 - blue, 3 - zone
  LIN2.write(0x20, package, 4); // Write data to LIN
//  byte package2[5] = {31, 0, 255, 0, 3}; // 31 - control byte, 0 - red, 255 - green, 0 - blue, 3 - zone
//  LIN1.write(0xA3, package2, 5); // Write data to LIN
  delay(20); // 10 s delay is used for testing Sniffer and LIN2LIN Gateway examples, lower value can be used
}
